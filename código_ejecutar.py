...
diar_bas.columns = ['Depósitos del tesoro en pesos\n(en millones)','Depósitos del tesoro en usd\n(en millones)']
...
Tasas = Tasas[::-1]
Tasas = Tasas.round(2)
Tasas.to_csv('Principales_Tasas_de_Interés_de_Mercado.csv', index=True)
...
Variacion_Acumulada.to_csv('Variación_Acumulada_RRII_Factores_Explicación_Gestión_Milei.csv',index=True)
